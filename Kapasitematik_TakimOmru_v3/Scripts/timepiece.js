...
var KTDatatablees = function () {
    ...
    var datatable;
    var Kategoris = function () {

        datatable = $('.machinetime').KTDatatable({
            data: {
                type: 'remote',
                method: 'GET',
                source: {
    ...
    function machineDetail(e) {
        $('<div/>').attr('class', 'datatabletime_' + e.data.MachineID).appendTo(e.detailCell).KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
    ...
    function subTableInit(e) {
        ...
        $('<div/>').attr('class', 'time_' + e.data.PieceId).appendTo(e.detailCell).KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
                        url: 'AltKategoriTime?PieceId=' + e.data.PieceId,
    ...
    function subTableInitt(e) {
        ...
        $('<div/>').attr('id', 'child_time_' + e.data.SubPieceId).appendTo(e.detailCell).html("")
