...
Execute unit tests
```
    cd "AWS_Kapasitematik_Takim_Omru_CoreAPI_v1/test/AWS_Kapasitematik_Takim_Omru_CoreAPI_v1.Tests"
    dotnet test
```

Deploy application
```
    cd "AWS_Kapasitematik_Takim_Omru_CoreAPI_v1/src/AWS_Kapasitematik_Takim_Omru_CoreAPI_v1"
